...
var _Style2 = require('../style/Style.js');
 ...
 */
var DEFAULT_IMAGE_STYLE_ANCHOR = void 0;

/**
 * @type {module:ol/style/IconAnchorUnits}
 */
var DEFAULT_IMAGE_STYLE_ANCHOR_X_UNITS = void 0;

/**
 * @type {module:ol/style/IconAnchorUnits}
 */
var DEFAULT_IMAGE_STYLE_ANCHOR_Y_UNITS = void 0;

/**
 * @type {module:ol/size~Size}
 */
var DEFAULT_IMAGE_STYLE_SIZE = void 0;

/**
 * @type {string}
 */
var DEFAULT_IMAGE_STYLE_SRC = void 0;

/**
 * @type {number}
 */
var DEFAULT_IMAGE_SCALE_MULTIPLIER = void 0;
 ...
 * @type {string}
 */
var DEFAULT_NO_IMAGE_STYLE = void 0;
 ...
 * @type {module:ol/style/Stroke}
 */
var DEFAULT_TEXT_STROKE_STYLE = void 0;
...
function createStyleDefaults() {
  ...
  DEFAULT_STYLE = new _Style3.default({
    fill: DEFAULT_FILL_STYLE,
...
var KML = function (_XMLFeature) {
  ...
  function KML(opt_options) {
    ...
    var _this = _possibleConstructorReturn(this, (KML.__proto__ || Object.getPrototypeOf(KML)).call(this));
  ...
  _createClass(KML, [{
    ...
    value: function readNameFromNode(node) {
      ...
      for (var _n = node.firstElementChild; _n; _n = _n.nextElementSibling) {
        ...
        if ((0, _array.includes)(NAMESPACE_URIS, _n.namespaceURI) && (localName == 'Document' || localName == 'Folder' || localName == 'Placemark' || localName == 'kml')) {
    ...
    value: function readNetworkLinksFromNode(node) {
      ...
      for (var _n2 = node.firstElementChild; _n2; _n2 = _n2.nextElementSibling) {
        ...
        if ((0, _array.includes)(NAMESPACE_URIS, _n2.namespaceURI) && (localName == 'Document' || localName == 'Folder' || localName == 'kml')) {
          (0, _array.extend)(networkLinks, this.readNetworkLinksFromNode(_n2));
        }
      }
      return networkLinks;
    }
    ...
    value: function readRegionFromNode(node) {
      ...
      for (var _n3 = node.firstElementChild; _n3; _n3 = _n3.nextElementSibling) {
        ...
        if ((0, _array.includes)(NAMESPACE_URIS, _n3.namespaceURI) && (localName == 'Document' || localName == 'Folder' || localName == 'kml')) {
          (0, _array.extend)(regions, this.readRegionFromNode(_n3));
        }
      }
      return regions;
    }
...
function createNameStyleFunction(foundStyle, name) {
  ...
  var nameStyle = new _Style3.default({
    text: textStyle
  });
  return nameStyle;
}
...
function setCommonGeometryProperties(multiGeometry, geometries) {
  ...
  var hasExtrude = void 0,
      hasTessellate = void 0,
      hasAltitudeMode = void 0;
...
function pairDataParser(node, objectStack) {
  ...
  if (key && key == 'normal') {
    ...
    var _Style = /** @type {module:ol/style/Style} */
    pairObject['Style'];
    if (_Style) {
      objectStack[objectStack.length - 1] = _Style;
    }
  }
}
...
var GEOMETRY_NODE_FACTORY = function GEOMETRY_NODE_FACTORY(value, objectStack, opt_nodeName) {
  if (value) {
    var parentNode = objectStack[objectStack.length - 1].node;
    return (0, _xml.createElementNS)(parentNode.namespaceURI, GEOMETRY_TYPE_TO_NODENAME[/** @type {module:ol/geom/Geometry} */value.getType()]);
  }
};
...
function writeMultiGeometry(node, geometry, objectStack) {
  ...
  if (type == _GeometryType2.default.GEOMETRY_COLLECTION) {
    ...
    geometries = /** @type {module:ol/geom/MultiLineString} */geometry.getLineStrings();
    factory = LINE_STRING_NODE_FACTORY;
  } else if (type == _GeometryType2.default.MULTI_POLYGON) {
    geometries = /** @type {module:ol/geom/MultiPolygon} */geometry.getPolygons();
...
function writePlacemark(node, feature, objectStack) {
  ...
  var geometry = feature.getGeometry();
  if (geometry) {
    geometry = (0, _Feature3.transformWithOptions)(geometry, true, options);
  }
...
function writeStyle(node, style, objectStack) {
  ...
  var textStyle = style.getText();
  if (imageStyle instanceof _Icon2.default) {
