 ...
 * @api
 */
var GreaterThan = function (_ComparisonBinary) {
  _inherits(GreaterThan, _ComparisonBinary);
  ...
  function GreaterThan(propertyName, expression) {
    ...
    return _possibleConstructorReturn(this, (GreaterThan.__proto__ || Object.getPrototypeOf(GreaterThan)).call(this, 'PropertyIsGreaterThan', propertyName, expression));
  }
