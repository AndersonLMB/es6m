...
var MapRenderer = function (_Disposable) {
  ...
  function MapRenderer(map) {
     ...
     */
    var _this = _possibleConstructorReturn(this, (MapRenderer.__proto__ || Object.getPrototypeOf(MapRenderer)).call(this));
     ...
     */
    _this.layerRendererConstructors_ = [];
  ...
  _createClass(MapRenderer, [{
    ...
    key: 'getLayerRendererConstructors',
    value: function getLayerRendererConstructors() {
    ...
    key: 'removeLayerRenderers',
    value: function removeLayerRenderers() {
    ...
    key: 'getLayerRenderer',
    value: function getLayerRenderer(layer) {
    ...
    key: 'getLayerRendererByKey',
    value: function getLayerRendererByKey(layerKey) {
      return this.layerRenderers_[layerKey];
    }
    ...
    key: 'getLayerRenderers',
    value: function getLayerRenderers() {
    ...
    key: 'handleLayerRendererChange_',
    value: function handleLayerRendererChange_() {
      this.map_.render();
    }
    ...
    key: 'removeLayerRendererByKey_',
    value: function removeLayerRendererByKey_(layerKey) {
    ...
    key: 'removeUnusedLayerRenderers_',
    value: function removeUnusedLayerRenderers_(map, frameState) {
    ...
    key: 'scheduleRemoveUnusedLayerRenderers',
    value: function scheduleRemoveUnusedLayerRenderers(frameState) {
      for (var layerKey in this.layerRenderers_) {
