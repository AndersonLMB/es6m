  ...
  _createClass(View, [{
    ...
    value: function updateAnimations_() {
      ...
      for (var i = this.animations_.length - 1; i >= 0; --i) {
        ...
        if (seriesComplete) {
          (function () {
            _this2.animations_[i] = null;
            _this2.setHint(_ViewHint2.default.ANIMATING, -1);
    ...
    key: 'getSizeFromViewport_',
    value: function getSizeFromViewport_() {
      var size = [100, 100];
    ...
    key: 'constrainCenter',
    value: function constrainCenter(center) {
    ...
    key: 'constrainResolution',
    value: function constrainResolution(resolution, opt_delta, opt_direction) {
    ...
    key: 'constrainRotation',
    value: function constrainRotation(rotation, opt_delta) {
      var delta = opt_delta || 0;
    ...
    key: 'getHints',
    value: function getHints(opt_hints) {
    ...
    key: 'calculateExtent',
    value: function calculateExtent(opt_size) {
    ...
    value: function getResolutionForExtent(extent, opt_size) {
      var size = opt_size || this.getSizeFromViewport_();
    ...
    value: function getResolutionForValueFunction(opt_power) {
    ...
    value: function getValueForResolutionFunction(opt_power) {
      var power = opt_power || 2;
      var maxResolution = this.maxResolution_;
      var minResolution = this.minResolution_;
      var max = Math.log(maxResolution / minResolution) / Math.log(power);
    ...
    key: 'fit',
    value: function fit(geometryOrExtent, opt_options) {
    ...
    key: 'rotate',
    value: function rotate(rotation, opt_anchor) {
