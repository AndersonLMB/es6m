...
var ExtentInteractionEvent = function (_Event) {
  _inherits(ExtentInteractionEvent, _Event);

  /**
   * @param {module:ol/extent~Extent} extent the new extent
   */
  function ExtentInteractionEvent(extent) {
    _classCallCheck(this, ExtentInteractionEvent);
     ...
     * @api
     */
    var _this = _possibleConstructorReturn(this, (ExtentInteractionEvent.__proto__ || Object.getPrototypeOf(ExtentInteractionEvent)).call(this, ExtentEventType.EXTENTCHANGED));
...
var ExtentInteraction = function (_PointerInteraction) {
  _inherits(ExtentInteraction, _PointerInteraction);

  /**
   * @param {module:ol/interaction/Extent~Options=} opt_options Options.
   */
  function ExtentInteraction(opt_options) {
    _classCallCheck(this, ExtentInteraction);

    var _this2 = _possibleConstructorReturn(this, (ExtentInteraction.__proto__ || Object.getPrototypeOf(ExtentInteraction)).call(this, {
     ...
     * @private
     */
    _this2.extentOverlay_ = new _Vector2.default({
     ...
     * @private
     */
    _this2.vertexOverlay_ = new _Vector2.default({
      source: new _Vector4.default({
        useSpatialIndex: false,
        wrapX: !!opt_options.wrapX
      }),
    ...
    if (opt_options.extent) {
      _this2.setExtent(opt_options.extent);
    }
    return _this2;
  }
  ...
  _createClass(ExtentInteraction, [{
    key: 'snapToVertex_',
    value: function snapToVertex_(pixel, map) {
    ...
    value: function handlePointerMove_(mapBrowserEvent) {
    ...
    key: 'createOrUpdateExtentFeature_',
    value: function createOrUpdateExtentFeature_(extent) {
    ...
    key: 'createOrUpdatePointerFeature_',
    value: function createOrUpdatePointerFeature_(vertex) {
    ...
    value: function setMap(map) {
      ...
      _get(ExtentInteraction.prototype.__proto__ || Object.getPrototypeOf(ExtentInteraction.prototype), 'setMap', this).call(this, map);
    }
