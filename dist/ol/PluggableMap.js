 ...
 * @api
 */
var PluggableMap = function (_BaseObject) {
  _inherits(PluggableMap, _BaseObject);

  /**
   * @param {module:ol/PluggableMap~MapOptions} options Map options.
   */
  function PluggableMap(options) {
    _classCallCheck(this, PluggableMap);

    var _this = _possibleConstructorReturn(this, (PluggableMap.__proto__ || Object.getPrototypeOf(PluggableMap)).call(this));
     ...
     * @private
     */
    _this.loadTilesWhileAnimating_ = options.loadTilesWhileAnimating !== undefined ? options.loadTilesWhileAnimating : false;

    /**
     * @type {boolean}
     * @private
     */
    _this.loadTilesWhileInteracting_ = options.loadTilesWhileInteracting !== undefined ? options.loadTilesWhileInteracting : false;
    ...
    _this.viewport_.className = 'ol-viewport' + (_has.TOUCH ? ' ol-touch' : '');
    ...
    for (var i = 0, ii = overlayEvents.length; i < ii; ++i) {
      (0, _events.listen)(_this.overlayContainerStopEvent_, overlayEvents[i], _Event.stopPropagation);
    }
    ...
    for (var key in _MapBrowserEventType2.default) {
      (0, _events.listen)(_this.mapBrowserEventHandler_, _MapBrowserEventType2.default[key], _this.handleMapBrowserEvent, _this);
    }
    ...
    (0, _events.listen)(_this.viewport_, _EventType2.default.CONTEXTMENU, _this.handleBrowserEvent, _this);
    (0, _events.listen)(_this.viewport_, _EventType2.default.WHEEL, _this.handleBrowserEvent, _this);
    (0, _events.listen)(_this.viewport_, _EventType2.default.MOUSEWHEEL, _this.handleBrowserEvent, _this);
    ...
    (0, _events.listen)(_this, (0, _Object.getChangeEventType)(_MapProperty2.default.LAYERGROUP), _this.handleLayerGroupChanged_, _this);
    (0, _events.listen)(_this, (0, _Object.getChangeEventType)(_MapProperty2.default.VIEW), _this.handleViewChanged_, _this);
    (0, _events.listen)(_this, (0, _Object.getChangeEventType)(_MapProperty2.default.SIZE), _this.handleSizeChanged_, _this);
    (0, _events.listen)(_this, (0, _Object.getChangeEventType)(_MapProperty2.default.TARGET), _this.handleTargetChanged_, _this);
    ...
    (0, _events.listen)(_this.controls, _CollectionEventType2.default.ADD,
    /**
    ...
    (0, _events.listen)(_this.controls, _CollectionEventType2.default.REMOVE,
    /**
     * @param {module:ol/Collection~CollectionEvent} event CollectionEvent.
     */
    function (event) {
    ...
    (0, _events.listen)(_this.interactions, _CollectionEventType2.default.ADD,
    /**
     * @param {module:ol/Collection~CollectionEvent} event CollectionEvent.
     */
    function (event) {
    ...
    (0, _events.listen)(_this.interactions, _CollectionEventType2.default.REMOVE,
    /**
     * @param {module:ol/Collection~CollectionEvent} event CollectionEvent.
     */
    function (event) {
    ...
    (0, _events.listen)(_this.overlays_, _CollectionEventType2.default.ADD,
    /**
     * @param {module:ol/Collection~CollectionEvent} event CollectionEvent.
     */
    function (event) {
    ...
    (0, _events.listen)(_this.overlays_, _CollectionEventType2.default.REMOVE,
    /**
     * @param {module:ol/Collection~CollectionEvent} event CollectionEvent.
     */
    function (event) {
  ...
  _createClass(PluggableMap, [{
    ...
    value: function disposeInternal() {
      ...
      this.setTarget(null);
      _get(PluggableMap.prototype.__proto__ || Object.getPrototypeOf(PluggableMap.prototype), 'disposeInternal', this).call(this);
    }
    ...
    value: function forEachFeatureAtPixel(pixel, callback, opt_options) {
      if (!this.frameState_) {
        return;
      }
    ...
    value: function getFeaturesAtPixel(pixel, opt_options) {
      var features = null;
    ...
    value: function forEachLayerAtPixel(pixel, callback, opt_options) {
      if (!this.frameState_) {
        return;
      }
    ...
    value: function hasFeatureAtPixel(pixel, opt_options) {
      if (!this.frameState_) {
        return false;
      }
      var coordinate = this.getCoordinateFromPixel(pixel);
    ...
    value: function handleBrowserEvent(browserEvent, opt_type) {
    ...
    key: 'skipFeature',
    value: function skipFeature(feature) {
    ...
    key: 'unskipFeature',
    value: function unskipFeature(feature) {
      var featureUid = (0, _util.getUid)(feature).toString();
