...
var WebGLPolygonReplay = function (_WebGLReplay) {
  _inherits(WebGLPolygonReplay, _WebGLReplay);
  ...
  function WebGLPolygonReplay(tolerance, maxExtent) {
    _classCallCheck(this, WebGLPolygonReplay);

    var _this = _possibleConstructorReturn(this, (WebGLPolygonReplay.__proto__ || Object.getPrototypeOf(WebGLPolygonReplay)).call(this, tolerance, maxExtent));

    _this.lineStringReplay = new _LineStringReplay2.default(tolerance, maxExtent);
  ...
  _createClass(WebGLPolygonReplay, [{
    key: 'drawCoordinates_',
    value: function drawCoordinates_(flatCoordinates, holeFlatCoordinates, stride) {
    ...
    key: 'processFlatCoordinates_',
    value: function processFlatCoordinates_(flatCoordinates, stride, list, rtree, clockwise) {
    ...
    key: 'getMaxCoords_',
    value: function getMaxCoords_(list) {
    ...
    key: 'classifyPoints_',
    value: function classifyPoints_(list, rtree, ccw) {
      var start = list.firstItem();
      var s0 = start;
    ...
    key: 'bridgeHole_',
    value: function bridgeHole_(hole, holeMaxX, list, listMaxX, rtree) {
    ...
    key: 'triangulate_',
    value: function triangulate_(list, rtree) {
      var ccw = false;
    ...
    key: 'clipEars_',
    value: function clipEars_(list, rtree, simple, ccw) {
      var numIndices = this.indices.length;
      var start = list.firstItem();
    ...
    */
    ...
    key: 'resolveSelfIntersections_',
    value: function resolveSelfIntersections_(list, rtree, opt_touch) {
      var start = list.firstItem();
      list.nextItem();
      var s0 = start;
      var s1 = list.nextItem();
    ...
    key: 'isSimple_',
    value: function isSimple_(list, rtree) {
      var start = list.firstItem();
      var seg = start;
      do {
    ...
    key: 'isClockwise_',
    value: function isClockwise_(list) {
    ...
    key: 'splitPolygon_',
    value: function splitPolygon_(list, rtree) {
      var start = list.firstItem();
      var s0 = start;
      do {
    ...
    key: 'createPoint_',
    value: function createPoint_(x, y, i) {
      var numVertices = this.vertices.length;
    ...
    key: 'insertItem_',
    value: function insertItem_(p0, p1, list, opt_rtree) {
      var seg = {
        p0: p0,
        p1: p1
      };
    ...
    key: 'removeItem_',
    value: function removeItem_(s0, s1, list, rtree) {
    ...
    key: 'getPointsInTriangle_',
    value: function getPointsInTriangle_(p0, p1, p2, rtree, opt_reflex) {
      var result = [];
    ...
    key: 'getIntersections_',
    value: function getIntersections_(segment, rtree, opt_touch) {
      var p0 = segment.p0;
      var p1 = segment.p1;
    ...
    key: 'calculateIntersection_',
    value: function calculateIntersection_(p0, p1, p2, p3, opt_touch) {
    ...
    key: 'diagonalIsInside_',
    value: function diagonalIsInside_(p0, p1, p2, p3, p4) {
