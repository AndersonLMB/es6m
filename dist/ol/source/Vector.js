 ...
 * type.
 */
var VectorSourceEvent = exports.VectorSourceEvent = function (_Event) {
  ...
  function VectorSourceEvent(type, opt_feature) {
     ...
     * @api
     */
    var _this = _possibleConstructorReturn(this, (VectorSourceEvent.__proto__ || Object.getPrototypeOf(VectorSourceEvent)).call(this, type));
...
var VectorSource = function (_Source) {
  ...
  function VectorSource(opt_options) {
     ...
     */
    var _this2 = _possibleConstructorReturn(this, (VectorSource.__proto__ || Object.getPrototypeOf(VectorSource)).call(this, {
    ...
    if (options.loader !== undefined) {
      ...
      (0, _asserts.assert)(_this2.format_, 7); // `format` must be set when `url` is set
      // create a XHR feature loader for "url" and "format"
      _this2.loader_ = (0, _featureloader.xhr)(_this2.url_, /** @type {module:ol/format/Feature} */_this2.format_);
    }
     ...
     */
    _this2.featuresRtree_ = useSpatialIndex ? new _RBush2.default() : null;

    /**
     * @private
     * @type {module:ol/structs/RBush<{extent: module:ol/extent~Extent}>}
     */
    _this2.loadedExtentsRtree_ = new _RBush2.default();
...
VectorSource.prototype.addFeaturesInternal = function (features) {
  ...
  for (var _i = 0, _length = newFeatures.length; _i < _length; _i++) {
    ...
    var _featureKey = (0, _util.getUid)(_feature).toString();
...
VectorSource.prototype.loadFeatures = function (extent, resolution, projection) {
  ...
  var _loop = function _loop(i, ii) {
    ...
    if (!alreadyLoaded) {
      _this3.loader_.call(_this3, extentToLoad, resolution, projection);
